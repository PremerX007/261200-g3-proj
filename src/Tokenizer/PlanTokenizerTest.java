...
class PlanTokenizerTest {
    ...
    void acceptNumber() throws LexicalError, IOException {
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/acceptNumber.txt"));
    ...
    void acceptOperator() throws LexicalError, IOException {
        String[] correct = {"+", "-", "*", "/", "=", "%", "^"};
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/acceptOperator.txt"));
    ...
    void acceptCorrectWord() throws LexicalError, IOException {
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/acceptCorrectWord.txt"));
    ...
    void supportEndOfLineComments() throws LexicalError, IOException {
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/endOfLineComments.txt"));
        while (exr.hasNextToken()) {
    ...
    void whenFileNotFound() {
        assertThrows(IOException.class, () -> new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/xyz.txt")));
    }

    @Test
    void whenFileEmpty() throws LexicalError, IOException {
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/emptyfile.txt"));
    ...
    void sampleConstructionPlan() throws LexicalError, IOException {
        PlanTokenizer exr = new PlanTokenizer(new FileReader("src/Tokenizer/TestTokenPlaintext/sampleCons.txt"));
